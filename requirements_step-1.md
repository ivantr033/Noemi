# Требования к 1-ому этапу

## Задание

Сверстать макет стационарной версии [./sources/psd/NOEMI_mq_desktop.psd](./sources/psd/NOEMI_mq_desktop.psd) 
в соответствии с требованиями ниже

## Требования

#### Содержание
- [Требования к 1-ому этапу](#требования-к-1-ому-этапу)
  - [Задание](#задание)
